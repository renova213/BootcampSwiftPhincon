...
class EditProfileViewController: UIViewController {
    ...
    @objc func buttonPop() {
        let user = UserEntity(name: usernameField.textField.text!, email: emailField.textField.text!, phone: phoneField.textField.text!)
        
        delegate?.passData(image: imageChoosen, user: user)
...
extension EditProfileViewController: ProfileViewControllerDelegate{
    func passData(user: UserEntity) {
        emailField.textField.text = user.email
        usernameField.textField.text = user.name
